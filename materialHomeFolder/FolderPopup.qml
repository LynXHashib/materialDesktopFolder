...
Item {
    ...
    onVisTChanged: {
        if (visT >= 0.999 && state_.phase === 1) state_.phase = 2
        else if (visT <= 0.001 && state_.phase === 3) state_.phase = 0
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.rgba(
                theme.colSurfaceBright.r,
                theme.colSurfaceBright.g,
                theme.colSurfaceBright.b,
                0.92
            )
        ...
        Item {
            anchors.fill: parent
            opacity: Math.max(0.0, (root.visT - 0.60) / 0.40)
            ...
            Text {
                ...
                font.pixelSize: 14; font.family: "sans-serif"; font.weight: Font.Medium
            }
            ...
            Rectangle {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                width: titleText.implicitWidth + 6; height: 2; radius: 1
                color: theme.colPrimary; opacity: 0.65
            }

            Grid {
                anchors.top: titleText.bottom; anchors.topMargin: 18
                anchors.horizontalCenter: parent.horizontalCenter
                columns: root.cols; spacing: 10
